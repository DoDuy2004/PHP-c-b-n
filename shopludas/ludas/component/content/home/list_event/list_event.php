        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                    ...
                    <a class="promotion" href=<?php echo'"'.$level.PAGES_PATH.'shop-grid-full.php"'?>>
                        <div class="aspect aspect--bg-grey aspect--square">

                            <img class="aspect__img promotion__img" src=<?php echo'"'.$level.IMG_PATH.'promo/promo-img-1.jpg"'?> alt=""></div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                    ...
                    <a class="promotion" href=<?php echo'"'.$level.PAGES_PATH.'shop-grid-full.php"'?>>
                        <div class="aspect aspect--bg-grey aspect--square">
                            ...
                            <img class="aspect__img promotion__img" src=<?php echo'"'.$level.IMG_PATH.'promo/promo-img-2.jpg"'?> alt=""></div>
                        <div class="promotion__content">
                            <div class="promotion__text-wrap">
                                <div class="promotion__text-1">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                    ...
                    <a class="promotion" href=<?php echo'"'.$level.PAGES_PATH.'shop-grid-full.php"'?>>
                        <div class="aspect aspect--bg-grey aspect--square">
                            ...
                            <img class="aspect__img promotion__img" src=<?php echo'"'.$level.IMG_PATH.'promo/promo-img-3.jpg"'?> alt=""></div>
                        <div class="promotion__content">
                            <div class="promotion__text-wrap">
                                <div class="promotion__text-1">

                                    <span class="u-c-secondary">ASUS FOR NEW GENERATION</span></div>
                                <div class="promotion__text-2">
