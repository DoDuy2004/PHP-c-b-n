                            ...
                            <div class="pd-wrap">
                                <div id="js-product-detail-modal">
                                    <div>
                                        ...
                                        <img class="u-img-fluid" src=<?php echo'"'.$level.IMG_PATH.'product/product-d-1.jpg"'?> alt=""></div>
                                    <div>

                                        <img class="u-img-fluid" src=<?php echo'"'.$level.IMG_PATH.'product/product-d-2.jpg"'?> alt=""></div>
                                    <div>

                                        <img class="u-img-fluid" src=<?php echo'"'.$level.IMG_PATH.'product/product-d-3.jpg"'?> alt=""></div>
                                    <div>

                                        <img class="u-img-fluid" src=<?php echo'"'.$level.IMG_PATH.'product/product-d-4.jpg"'?> alt=""></div>
                                    <div>

                                        <img class="u-img-fluid" src=<?php echo'"'.$level.IMG_PATH.'product/product-d-5.jpg"'?> alt=""></div>
                                </div>
                            </div>
                            ...
                            <div class="u-s-m-b-15">
                                <div class="pd-detail__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i>
                                    ...
                                    <span class="pd-detail__review u-s-m-l-4">
                                        ...
                                        <a href=<?php echo'"'.$level.PAGES_PATH.'product-detail.php"'?>>23 Reviews</a></span></div>
                            </div>
                            <div class="u-s-m-b-15">
                                <div class="pd-detail__inline">
