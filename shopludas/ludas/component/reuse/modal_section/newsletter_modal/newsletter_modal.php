            ...
            <div class="modal-body">
                <div class="row u-s-m-x-0">
                    <div class="col-lg-6 new-l__col-1 u-s-p-x-0">
                        ...
                        <a class="new-l__img-wrap u-d-block" href=<?php echo'"'.$level.PAGES_PATH.'shop-grid-full.php"'?>>

                            <img class="u-img-fluid u-d-block" src=<?php echo'"'.$level.IMG_PATH.'newsletter/newsletter.jpg"'?> alt=""></a></div>
