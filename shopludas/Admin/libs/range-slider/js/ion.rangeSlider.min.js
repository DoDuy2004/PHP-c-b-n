...
! function(i) {
    ...
    h.prototype = {
            ...
            appendDisableMask: function() {
                this.$cache.cont.append('<span class="irs-disable-input-mask"></span>'), this.$cache.cont.addClass("irs-disabled")
            },
            removeDisableMask: function() {
                this.$cache.cont.remove(".irs-disable-input-mask"), this.$cache.cont.removeClass("irs-disabled")
            },
            remove: function() {
