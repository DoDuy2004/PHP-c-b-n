                    ...
                    <div class="chat-lists">
                        <div class="list-group list-group-flush">
                            ...
                            <div class="list-group-item d-flex align-items-center">
                                <div class="pe-3">
                                    <span class="avatar avatar-state-warning">
                                        <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/man_avatar4.jpg"'?>
                                            class="rounded-circle" alt="image">
                                    </span>
                                </div>
                                <div class="flex-grow-1">
                    ...
                    <div class="list-group list-group-flush">
                        <a href="#" class="list-group-item d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="text-muted d-flex align-items-center">
                                    <i class="bi bi-arrow-down me-1 text-danger small"></i> Today, 03:11 AM
                                </div>
                            </div>
                        ...
                        <a href="#" class="list-group-item d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <div class="text-muted d-flex align-items-center">
                                    <i class="bi bi-arrow-up me-1 text-success small"></i> Today, 03:11 AM
                                </div>
                            </div>
                            <div class="text-end ms-auto">
    ...
    <div class="chat-content empty-chat-wrapper">
        ...
        <div class="empty-chat">
            <div class="row mb-5">
                <div class="col-md-4 m-auto">
                    <img class="img-fluid" src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'not-selected-chat.svg"'?> alt="image">
                </div>
            </div>
        ...
        <div class="messages">
            ...
            <div class="message-item me message-media">
                <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'photo1.jpg"'?> alt="image">
                <span class="time small text-muted font-italic">02:30 PM</span>
            </div>
