            ...
            <div class="py-4">
                ...
                <div class="mb-4">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <i class="bi bi-check2 me-2"></i> Voice chat
                        </li>
                        <li class="list-group-item">
                            <i class="bi bi-check2 me-2"></i> To be able to invite users
                        </li>
                        <li class="list-group-item">
                            <i class="bi bi-x text-danger me-2"></i>
                        ...
                        <li class="list-group-item">
                            <i class="bi bi-check2 me-2"></i> Chat without limit
                        </li>
                        <li class="list-group-item">
                            <i class="bi bi-x text-danger me-2"></i>
            ...
            <div class="py-4">
                ...
                <div class="mb-4">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <i class="bi bi-check2 me-2"></i> Creating a group
                        </li>
                        <li class="list-group-item">
                            <i class="bi bi-check2 me-2"></i> Chat without limit
                        </li>
                        <li class="list-group-item">
                            <i class="bi bi-check2 me-2"></i> Team work
                        </li>
                    </ul>
                </div>
                <div class="text-center">
        ...
        <div class="card">
            <div class="py-4">
                ...
                <div class="mb-4">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <i class="bi bi-check2 me-2"></i> Video chat
                        </li>
                        <li class="list-group-item">
                            <i class="bi bi-check2 me-2"></i> Voice chat
                        </li>
                        ...
                        <li class="list-group-item">
                            <i class="bi bi-check2 me-2"></i> Unlimited file exchange
                        </li>
                        <li class="list-group-item">
                            <i class="bi bi-check2 me-2"></i> Creating a group
                        </li>
