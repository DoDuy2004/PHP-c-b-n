                    ...
                    <div class="row align-items-center">
                        <div class="col-md-10 offset-md-1">
                            ...
                            <p class="text-center d-block d-lg-none mt-4 mt-lg-0">
                                You can now <a href=<?php echo'"'.$level.PAGES_PATH.'login.php"'?>>sign in</a>
                                <!-- <a href=<?php //echo'"'.$level.PAGES_PATH.'register.php"'?>>create anaccount</a>. -->
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col d-none d-lg-flex border-start align-items-center justify-content-between flex-column text-center">
                    ...
                    <div>
                        ...
                        <div class="text-center">
                            You can now <a class="btn btn-primary btn-sm" href=<?php echo'"'.$level.PAGES_PATH.'login.php"'?>>sign in</a>
