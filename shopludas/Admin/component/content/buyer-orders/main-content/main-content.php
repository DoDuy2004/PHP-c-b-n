<div class="row">
                        ...
                        <table class="table table-custom mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="#">
                                            <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'products/2.jpg"'?> class="rounded"
                                                width="40" alt="...">
                                        </a>
                                    </td>
                                    <td>Shoe</td>
                                ...
                                <tr>
                                    <td>
                                        <a href="#">
                                            <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'products/3.jpg"'?> class="rounded"
                                                width="40" alt="...">
                                        </a>
                                    </td>
                                    <td>Digital clock</td>
                        ...
                        <table class="table table-custom mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="#">
                                            <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'products/6.jpg"'?> class="rounded"
                                                width="40" alt="...">
                                        </a>
                                    </td>
                                    <td>Shoe</td>
                        ...
                        <table class="table table-custom">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="#">
                                            <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'products/8.jpg"'?> class="rounded"
                                                width="40" alt="...">
                                        </a>
                                    </td>
                                    <td>Headphone</td>
                                ...
                                <tr>
                                    <td>
                                        <a href="#">
                                            <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'products/9.jpg"'?> class="rounded"
                                                width="40" alt="...">
                                        </a>
                                    </td>
                                    <td>Perfume</td>
                                ...
                                <tr>
                                    <td>
                                        <a href="#">
                                            <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'products/10.jpg"'?> class="rounded"
                                                width="40" alt="...">
                                        </a>
                                    </td>
                                    <td>Cookie</td>
    ...
    <?php include $level.COMPONENT_PATH.REUSE_PATH.'link.php' ?>
</div>