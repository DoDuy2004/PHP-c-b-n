<?php include $level.COMPONENT_PATH.REUSE_PATH.'bg_profile.php'?>

<div class="row g-4">
    <div class="col-lg-7 col-md-12">
        <ul class="nav nav-pills mb-4">
            <li class="nav-item">
                <a class="nav-link active" href=<?php echo'"'.$level.PAGES_PATH.'profile-posts.php"'?>>Posts</a>
            </li>
            <li class="nav-item">
                <a class="nav-link " href=<?php echo'"'.$level.PAGES_PATH.'profile-connections.php"'?>>Connections</a>
            </li>
        </ul>
            ...
            <div class="card-body">
                ...
                <form class="d-flex">
                    <div class="avatar avatar-sm me-3 flex-shrink-0">
                        <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/women_avatar1.jpg"'?>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex mb-3">
                    <div class="d-flex">
                        <figure class="avatar me-3">
                            <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/man_avatar3.jpg"'?> class="rounded-circle" alt="...">
                        </figure>
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam doloremque eveniet illo minus nemo
                    obcaecati, voluptatem? At corporis cum dolorem eos impedit in magni officiis quibusdam, ratione
                    sequi totam voluptatum.</p>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet dolor eos id ipsa nobis omnis,
                    tenetur? Dolor officiis omnis quo?</p>
                ...
                <div class="mt-4">
                        ...
                        <div class="d-flex mb-3">
                            <div class="d-flex align-items-center">
                                <figure class="avatar avatar-sm me-3">
                                    <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/man_avatar4.jpg"'?> class="rounded-circle"
                                        alt="...">
                                </figure>
                    ...
                    <div class="card card-body mb-4">
                        <div class="d-flex mb-3">
                            <div class="d-flex align-items-center">
                                <figure class="avatar avatar-sm me-3">
                                    <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/man_avatar1.jpg"'?> class="rounded-circle"
                                        alt="...">
                                </figure>
                                <div class="d-inline-block">
                                    <div>Jenni Odlin</div>
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. A, ad, assumenda at atque corporis
                            culpa earum id illum impedit laborum maxime minus nisi omnis quod sequi suscipit totam
                    ...
                    <form class="d-flex mt-3">
                        <div>
                            <figure class="avatar avatar-sm me-3">
                                <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/women_avatar1.jpg"'?> class="rounded-circle" alt="...">
                            </figure>
                        </div>
                        <div class="flex-grow-1">
                            <div class="mb-3">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item d-flex align-items-center px-0">
                        <figure class="avatar avatar-state-primary me-3">
                            <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/women_avatar5.jpg"'?> class="rounded-circle" alt="image">
                        </figure>
                        <div class="flex-fill">
                    ...
                    <li class="list-group-item d-flex align-items-center px-0">
                        <figure class="avatar avatar-state-secondary me-3">
                            <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/man_avatar1.jpg"'?> class="rounded-circle" alt="image">
                        </figure>
                        <div class="flex-fill">
                    ...
                    <li class="list-group-item d-flex align-items-center px-0">
                        <figure class="avatar avatar-state-success me-3">
                            <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/women_avatar1.jpg"'?> class="rounded-circle" alt="image">
                        </figure>
                        <div class="flex-fill">
                    ...
                    <li class="list-group-item d-flex align-items-center px-0">
                        <figure class="avatar avatar-state-warning me-3">
                            <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/women_avatar2.jpg"'?> class="rounded-circle" alt="image">
                        </figure>
                        <div class="flex-fill">
                ...
                <div class="d-flex align-items-center justify-content-center">
                    <div class="avatar-group me-2">
                        ...
                        <a href="#" class="avatar" data-bs-toggle="tooltip" title="Malanie Hanvey">
                            <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/man_avatar2.jpg"'?> class="rounded-circle" alt="image">
                        </a>
                        <a href="#" class="avatar" data-bs-toggle="tooltip" title="Kenneth Hune">
                            <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/women_avatar2.jpg"'?> class="rounded-circle" alt="image">
                        </a>
                        <a href="#" class="avatar" data-bs-toggle="tooltip" title="Kenneth Hune">
                            <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/women_avatar3.jpg"'?> class="rounded-circle" alt="image">
                        </a>
                    </div>
                    <span>+7 people</span>
                </div>
