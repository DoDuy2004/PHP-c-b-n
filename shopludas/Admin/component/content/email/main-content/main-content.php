...
<div class="row">
    <div class="col-lg-9">
        ...
        <div class="email-list">
            <ul class="list-group">
                <li class="list-group-item text-success" data-detail-url=<?php echo'"'.$level.PAGES_PATH.'email-detail.php"'?>>
                ...
                <li class="list-group-item" data-detail-url=<?php echo'"'.$level.PAGES_PATH.'email-detail.php"'?>>
                    <div class="flex-shrink-0">
                        <input class="form-check-input me-3" type="checkbox">
                    </div>
                    <div class="d-none d-sm-block flex-shrink-0">
                ...
                <li class="list-group-item text-success" data-detail-url=<?php echo'"'.$level.PAGES_PATH.'email-detail.php"'?>>
                    ...
                    <div class="d-none d-sm-block flex-shrink-0">
                        <figure class="avatar me-3">
                            <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/women_avatar3.jpg"'?> class="rounded-circle"
                                alt="image">
                        </figure>
                    </div>
                    <div class="flex-grow-1">
                ...
                <li class="list-group-item" data-detail-url=<?php echo'"'.$level.PAGES_PATH.'email-detail.php"'?>>
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="text-muted d-flex justify-content-between">
                            <div class="text-truncate">Lorem ipsum dolor sit amet, consectetur adipisicing
                                elit. Asperiores esse et hic nesciunt quas ratione rem reprehenderit
                                similique temporibus totam!
                            </div>
                            <i class="bi bi-paperclip"></i>
                        </div>
                    </div>
                ...
                <li class="list-group-item" data-detail-url=<?php echo'"'.$level.PAGES_PATH.'email-detail.php"'?>>
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="text-muted d-flex justify-content-between">
                            <div class="text-truncate">Hey John, bah kivu decrete epanorthotic unnotched
