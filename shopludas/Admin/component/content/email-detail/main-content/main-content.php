        ...
        <div class="d-flex align-items-center my-4">
            <div class="d-flex align-items-center">
                <div class="avatar me-3">
                    <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/women_avatar5.jpg"'?> class="rounded-circle"
                        alt="image">
                </div>
                <div>
                    <h6 class="mb-1">
                        Valentine Maton
                        <span
                            class="d-sm-inline fw-normal d-none text-muted ms-2">&lt;elnora@gmail.com&gt;</span>
                    </h6>
