<div class="card">
    <div class="card-body">
            ...
            <div>
                <div class="avatar-group">
                    ...
                    <figure class="avatar" title="Lisle Essam" data-bs-toggle="tooltip">
                        <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/women_avatar2.jpg"'?> class="rounded-circle"
                            alt="image">
                    </figure>
                    <figure class="avatar" title="Baxie Roseblade" data-bs-toggle="tooltip">
                        <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/man_avatar5.jpg"'?> class="rounded-circle"
                            alt="image">
                    </figure>
                    <figure class="avatar" title="Mella Mixter" data-bs-toggle="tooltip">
                        <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/women_avatar1.jpg"'?> class="rounded-circle"
                            alt="image">
                    </figure>
                </div>
            </div>
        ...
        <div class="mb-4">
            <p>Departure so attention pronounce satisfied daughters am. But shy tedious pressed studied
                opinion entered windows off. Advantage dependent suspicion convinced provision him yet.
                Timed balls match at by rooms we. Fat not boy neat
                left had with past here call. Court nay merit few nor party learn. Why our year her eyes
                know even how. Mr immediate remaining conveying allowance do or.
            </p>
            <p>Timed balls match at by rooms we. Fat not boy neat left had with past here call. Court nay
                merit few nor party learn. Why our year her eyes know even how. Mr immediate remaining
                conveying allowance do or.</p>
        </div>
