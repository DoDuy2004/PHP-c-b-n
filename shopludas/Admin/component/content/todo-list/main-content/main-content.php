<div class="row">
    <div class="col-md-9">
                ...
                <div class="me-3">
                    <div class="input-group">
                        <div class="input-group-text bg-white">
                            <input class="form-check-input todo-check-all mt-0" type="checkbox" value=""
                                aria-label="Checkbox for following text input">
                        </div>
                        <button class="btn btn-light bg-white dropdown-toggle" type="button"
        ...
        <div class="todo-list">
            <ul class="list-group">
                <li class="list-group-item gap-3" data-detail-url=<?php echo'"'.$level.PAGES_PATH.'todo-detail.php"'?>>
                            ...
                            <div class="d-sm-inline d-none">
                                <div class="avatar-group">
                                    <figure class="avatar avatar-sm" title="Lisle Essam"
                                        ...
                                        <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/women_avatar2.jpg"'?>
                                            class="rounded-circle" alt="image">
                                    </figure>
                                    <figure class="avatar avatar-sm" title="Baxie Roseblade"
                                        data-bs-toggle="tooltip">
                                        <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/man_avatar5.jpg"'?>
                                            class="rounded-circle" alt="image">
                                    </figure>
                                    ...
                                    <figure class="avatar avatar-sm" title="Cullie Philcott"
                                        data-bs-toggle="tooltip">
                                        <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/women_avatar5.jpg"'?>
                                            class="rounded-circle" alt="image">
                                    </figure>
                                </div>
                            </div>
                ...
                <li class="list-group-item gap-3 todo-completed" data-detail-url=<?php echo'"'.$level.PAGES_PATH.'todo-detail.php"'?>>
                    <div class="flex-shrink-0">
                        <i class="todo-sortable-handle bi bi-grip-horizontal"></i>
                    </div>
                    <div class="flex-shrink-0">
                ...
                <li class="list-group-item gap-3 todo-completed" data-detail-url=<?php echo'"'.$level.PAGES_PATH.'todo-detail.php"'?>>
                    ...
                    <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                        <div class="text-truncate">Dealing With Technical Support 10 Useful Tips
                        </div>
                        <div class="ps-3 d-flex gap-3 align-items-center flex-shrink-0">
                            <div class="d-sm-inline d-none">
                ...
                <li class="list-group-item gap-3" data-detail-url=<?php echo'"'.$level.PAGES_PATH.'todo-detail.php"'?>>
                    ...
                    <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                        <div class="text-truncate">Get The Boot A Birds Eye Look Into Mcse Boot Camps
                        </div>
                        <div class="ps-3 d-flex gap-3 align-items-center flex-shrink-0">
                            <div class="d-sm-inline d-none">
                                <div class="badge bg-danger">Social</div>
                ...
                <li class="list-group-item gap-3" data-detail-url=<?php echo'"'.$level.PAGES_PATH.'todo-detail.php"'?>>
                    ...
                    <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                        <div class="text-truncate">Success Steps For Your Personal Or Business Life
                        </div>
                        <div class="ps-3 d-flex gap-3 align-items-center flex-shrink-0">
                            <div class="d-sm-inline d-none">
                                <div class="badge bg-danger">Social</div>
                ...
                <li class="list-group-item gap-3" data-detail-url=<?php echo'"'.$level.PAGES_PATH.'todo-detail.php"'?>>
                    ...
                    <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                        <div class="text-truncate">Don't Let The Outtakes Take You Out
                        </div>
                        <div class="ps-3 d-flex gap-3 align-items-center flex-shrink-0">
                            <div class="d-sm-inline d-none">
                                <div class="badge bg-warning">Theme Support</div>
                ...
                <li class="list-group-item gap-3" data-detail-url=<?php echo'"'.$level.PAGES_PATH.'todo-detail.php"'?>>
                    ...
                    <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                        <div class="text-truncate">It is a good idea to think of your PC as an office.
                        </div>
                        <div class="ps-3 d-flex gap-3 align-items-center flex-shrink-0">
                            <div class="d-sm-inline d-none">
                                <div class="badge bg-warning">Theme Support</div>
            ...
            <div class="modal-body">
                <form autocomplete="off">
                    ...
                    <div class="mb-3 row row-sm">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control task-time-input" placeholder="Time">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9 d-flex justify-content-between">
                            <div class="avatar-group">
                                <figure class="avatar avatar-sm">
                                    <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/women_avatar3.jpg"'?>
                                        class="rounded-circle" alt="image">
                                </figure>
                            ...
                            <div>
                                <button type="button" class="btn" title="Add User"
                                    ...
                                    <div class="p-3">
                                        ...
                                        <ul class="list-group list-group-flush mt-2">
                                            <li class="list-group-item d-flex align-items-center ps-0 pe-0">
                                                ...
                                                <div class="dropdown ms-auto">
                                                    <a href="#" data-bs-toggle="dropdown"
                                                        class="btn btn-light btn-sm" aria-haspopup="true"
                                                        aria-expanded="false">
                                            ...
                                            <li class="list-group-item d-flex align-items-center ps-0 pe-0">
                                                <div class="me-2">
                                                    <figure class="avatar avatar-sm">
                                                        <img src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/man_avatar2.jpg"'?>
                                                            class="rounded-circle" alt="image">
                                                    </figure>
                                                </div>
                                                <div>
