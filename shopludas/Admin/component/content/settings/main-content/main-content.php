                ...
                <div class="mb-4">
                    <div class="d-flex flex-column flex-md-row text-center text-md-start mb-3">
                        <figure class="me-4 flex-shrink-0">
                            <img width="100" class="rounded-pill" src=<?php echo'"'.$level.ASSETS_PATH.IMG_PATH.'user/man_avatar3.jpg"'?> alt="...">
                        </figure>
                        <div class="flex-fill">
                        ...
                        <div class="list-group list-group-flush">
                                ...
                                <div class="d-md-flex justify-content-between align-items-center">
                                    <div class="d-flex align-items-center">
                                        <figure class="mb-0 me-3">
                                            <img src=<?php'"'.$level.ASSETS_PATH.'svg/logo-integration-slack.svg"'?> alt="...">
                                        </figure>
                                        <div>
                            ...
                            <div class="list-group-item p-4">
                                <div class="d-md-flex justify-content-between align-items-center">
                                    <div class="d-flex align-items-center">
                                        <figure class="mb-0 me-3">
                                            <img src=<?php'"'.$level.ASSETS_PATH.'svg/logo-integration-drive.svg"'?> alt="...">
                                        </figure>
                                        <div>
                            ...
                            <div class="list-group-item p-4">
                                <div class="d-md-flex justify-content-between align-items-center">
                                    <div class="d-flex align-items-center">
                                        <figure class="mb-0 me-3">
                                            <img src=<?php'"'.$level.ASSETS_PATH.'svg/logo-integration-dropbox.svg"'?> alt="...">
                                        </figure>
                                        <div>
